...
int16_t CH3_DC = 0;
uint16_t ch3_counter = 0;
uint16_t gl_counter_1000hz_tim2 = 0;
uint8_t gl_int_5hz_tim2 = 0;
uint8_t gl_int_5hz_tim2_for_pic = 0;
...
//	if(__HAL_GPIO_EXTI_GET_FLAG(IRQ_TCH_Pin) != RESET ) {
