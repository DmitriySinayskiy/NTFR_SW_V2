...
extern const uint16_t LOADING_1_data[];
extern const uint16_t LOADING_2_data[];
extern const uint16_t LOADING_3_data[];
extern const uint16_t LOAD_0_data[];
extern const uint16_t LOAD_10_data[];
extern const uint16_t LOAD_100_data[];
extern const uint16_t LOAD_150_data[];
extern const uint16_t LOAD_20_data[];
extern const uint16_t LOAD_200_data[];
extern const uint16_t LOAD_30_data[];
extern const uint16_t LOAD_40_data[];
extern const uint16_t LOAD_50_data[];
extern const uint16_t LOAD_60_data[];
extern const uint16_t LOAD_70_data[];
extern const uint16_t LOAD_80_data[];
extern const uint16_t LOAD_90_data[];

extern const uint16_t CHECK_MARK_L_data[];
extern const uint16_t CHECK_MARK_M_data[];
extern const uint16_t CROSS_MARK_L_data[];
extern const uint16_t CROSS_MARK_M_data[];
extern const uint16_t EXCLAMATION_MARK_L_data[];
extern const uint16_t EXCLAMATION_MARK_M_data[];

extern const uint16_t N_1_data[];
extern const uint16_t N_10_data[];
extern const uint16_t N_11_data[];
extern const uint16_t N_12_data[];
extern const uint16_t N_13_data[];
extern const uint16_t N_14_data[];
extern const uint16_t N_15_data[];
extern const uint16_t N_16_data[];
extern const uint16_t N_17_data[];
extern const uint16_t N_18_data[];
extern const uint16_t N_19_data[];
extern const uint16_t N_2_data[];
extern const uint16_t N_20_data[];
extern const uint16_t N_21_data[];
extern const uint16_t N_22_data[];
extern const uint16_t N_23_data[];
extern const uint16_t N_24_data[];
extern const uint16_t N_25_data[];
extern const uint16_t N_26_data[];
extern const uint16_t N_27_data[];
extern const uint16_t N_28_data[];
extern const uint16_t N_29_data[];
extern const uint16_t N_3_data[];
extern const uint16_t N_30_data[];
extern const uint16_t N_31_data[];
extern const uint16_t N_32_data[];
extern const uint16_t N_33_data[];
extern const uint16_t N_34_data[];
extern const uint16_t N_35_data[];
extern const uint16_t N_36_data[];
extern const uint16_t N_37_data[];
extern const uint16_t N_38_data[];
extern const uint16_t N_39_data[];
extern const uint16_t N_4_data[];
extern const uint16_t N_40_data[];
extern const uint16_t N_41_data[];
extern const uint16_t N_42_data[];
extern const uint16_t N_43_data[];
extern const uint16_t N_44_data[];
extern const uint16_t N_45_data[];
extern const uint16_t N_46_data[];
extern const uint16_t N_47_data[];
extern const uint16_t N_48_data[];
extern const uint16_t N_49_data[];
extern const uint16_t N_5_data[];
extern const uint16_t N_50_data[];
extern const uint16_t N_51_data[];
extern const uint16_t N_52_data[];
extern const uint16_t N_53_data[];
extern const uint16_t N_54_data[];
extern const uint16_t N_55_data[];
extern const uint16_t N_56_data[];
extern const uint16_t N_57_data[];
extern const uint16_t N_58_data[];
extern const uint16_t N_59_data[];
extern const uint16_t N_6_data[];
extern const uint16_t N_60_data[];
extern const uint16_t N_61_data[];
extern const uint16_t N_7_data[];
extern const uint16_t N_8_data[];
extern const uint16_t N_9_data[];
