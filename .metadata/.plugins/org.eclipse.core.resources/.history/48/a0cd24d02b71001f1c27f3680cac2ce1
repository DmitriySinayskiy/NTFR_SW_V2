...
//
//		  ST7735_FillScreen(ST7735_BLACK);
////		  display_product_norm(product_array[0].conductivity, ENGLISH);
//
//
//		  HAL_TIM_Base_Start_IT(&htim2);
//
//		  uint8_t load_bar_index = (conduct_acidity_loading_bar_calculation(product_array[60].conductivity, product_array[60].temperature_coeff, measuring_result));
//		  uint8_t result_status = display_loading_status(load_bar_index, product_array[60].id);
//
//		  display_measuring_product(product_array[60].addr_block_S, product_array[60].addr_offset_S, HORIZ_AFTER_MEASURING);
//		  display_measuring_text(product_array[60].name , product_array[60].conductivity, measuring_result, result_status, ENGLISH);
