...
extern const uint16_t ARROW_MAIN_DARK_RIGHT_data[];
extern const uint16_t ARROW_MAIN_LIGHT_RIGHT_data[];
extern const uint16_t ARROW_SUB_DARK_DOWN_data[];
extern const uint16_t ARROW_SUB_DARK_LEFT_data[];
extern const uint16_t ARROW_SUB_DARK_RIGHT_data[];
extern const uint16_t ARROW_SUB_DARK_UP_data[];
extern const uint16_t ARROW_SUB_LIGHT_DOWN_data[];
extern const uint16_t ARROW_SUB_LIGHT_LEFT_data[];
extern const uint16_t ARROW_SUB_LIGHT_RIGHT_data[];
extern const uint16_t ARROW_SUB_LIGHT_UP_data[];
